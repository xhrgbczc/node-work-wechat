...
WorkWechat.prototype = {
  ...
  encrypt (xmlMsg) {
    ...
    var base64String = cipheredMsg.toString('base64');
    console.log('wechat encrypt old base 64:' + base64String + '\n\n' + base64String.replace(new RegExp(/\r|\n/), ""))
    return base64String.replace(new RegExp(/\r|\n/), "");
  },
  decrypt (echostr) {
